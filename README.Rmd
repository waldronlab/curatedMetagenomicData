...
<!-- badges: start -->
[![GitHub Workflow Status](https://img.shields.io/github/workflow/status/waldronlab/curatedMetagenomicData/check-bioc)](https://github.com/waldronlab/curatedMetagenomicData/actions/workflows/check-bioc.yml)
