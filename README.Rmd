...
<!-- badges: start -->
[![GitHub Workflow Status](https://img.shields.io/github/workflow/status/waldronlab/curatedMetagenomicData/check-package)](https://github.com/waldronlab/curatedMetagenomicData/actions/workflows/check-package.yml)
