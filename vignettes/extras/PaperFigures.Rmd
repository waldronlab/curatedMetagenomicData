...
```{r suppfig3}
pam_bray <- sapply(2:10, function(i) pam(dist_bray, k = i, cluster.only = TRUE))
pam_js <- sapply(2:10, function(i) pam(dist_js, k = i, cluster.only = TRUE))
pam_rjs <- sapply(2:10, function(i) pam(dist_rjs, k = i, cluster.only = TRUE))

plot_cluster_validation = function(bray, js, rjs, legend = TRUE, ...) {
...
plot_cluster_validation(ch_bray, ch_js, ch_rjs, legend = TRUE, ylab = "Calinski-Harabasz score", ylim = c(0, 450))
...
plot_cluster_validation(si_bray, si_js, si_rjs, legend = FALSE, ylab = "Average silhouette width", ylim = c(0, 1))
...
plot_cluster_validation(ps_bray$mean.pred[2:10], ps_js$mean.pred[2:10], ps_rjs$mean.pred[2:10], ylab = "Prediction Strength", ylim = c(0, 1.1), legend = FALSE)
