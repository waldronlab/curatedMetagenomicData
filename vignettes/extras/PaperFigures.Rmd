...
title: "Paper Figures"
abstract: >
    The following analysis represnets all the code that is necessary to 
    ...
    data through ExperimentHub. bioRxiv. doi:10.1101/103085. Please note that 
    much of this analysis occured during the development stages of 
    curatedMetagenomicData and was written by multiple authors. As such, there 
    may exist 
output:
...
ggplot() +
    ...
    scale_color_gradient(low = gray, high = blueGreen, guide = guide_colorbar(direction = "horizontal", title = "Bacteroides \n(cluster 1)")) +
...
qplot(x = eset_pathway$prev, y = exprs(eset_pathway)[cors$feature[cors$r.cor == max(cors$r.cor)], ], xlab = "Prevotella copri abundance", ylab = "Pathway abundance", main = "Inosine 5 phosphate biosynthesis ", colour = I(black), shape = I(1))
```
...
legend("bottomright", box.lwd = 0, box.col = "transparent", bg = "transparent", lwd = 2, legend = dataset_list, col = pallet_reduced)
```
