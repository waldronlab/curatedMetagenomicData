...
vignette: >
    %\VignetteIndexEntry{Clustering of All Gut Samples using Taxonomic Abundance}
...
```{r plot_PCoA}
plot_ordination(pseq, ord_bray, color = "source") + ggtitle("Bray-Curtis Principal Coordinates Analysis")
plot_ordination(pseq, ord_JS, color = "source") + ggtitle("Jensen-Shannon Principal Coordinates Analysis")
plot_ordination(pseq, ord_RJS, color = "source") + ggtitle("Root Jensen-Shannon Principal Coordinates Analysis")
```
...
plot_ordination(pseq, ord_bray, color = "bray_cluster_2") + ggtitle("Bray-Curtis PCoA with 2 Clusters")
plot_ordination(pseq, ord_bray, color = "bray_cluster_3") + ggtitle("Bray-Curtis PCoA with 3 Clusters")
plot_ordination(pseq, ord_bray, color = "bray_cluster_4") + ggtitle("Bray-Curtis PCoA with 4 Clusters")
```
