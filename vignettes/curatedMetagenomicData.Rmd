...
3. Through the command-line interface, [curatedMetagenomicDataCLI](https://github.com/waldronlab/curatedMetagenomicDataCLI), but it is not part of the Bioconductor package or discussed here.
