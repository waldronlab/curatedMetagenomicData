...
# Download
For inclusion into curatedMetagenomicData 3, samples are downloaded dircelty from [**NCBI**](https://www.ncbi.nlm.nih.gov/) (depending on the data-availability statement).
...
The [LifeLines-deep](http://www.humanfunctionalgenomics.org/site/?page_id=86) and the [VilaAV_2018](https://stm.sciencemag.org/content/10/472/eaap8914) cohorts were obtained from [**EGA**](https://ega-archive.org/).
